---
title: "QM 2024 Week 12: Count Models"
author:
  - "Lisa-Marie Müller"
  - "Domantas Undzėnas"
...
Let $\mathcal{L_R}$ be the likelihood for the null, *restricted* model with $r$ parameters and $\mathcal{L_U}$ be the likelihood for the alternative, *unrestricted* model with $u$ parameters, $u>r$.
...
# but store the result as lambda (to follow the notation of the formula)
lambda1 <- exp(Xbeta1)
lambda2 <- exp(Xbeta2)
lambda3 <- exp(Xbeta3)
